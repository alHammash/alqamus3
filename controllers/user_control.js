 ...
 console.log("start update user ");
  ...
  //auth_token: token
       res.redirect('/profile.html?user=' + email + '&token=' + token + '&full_name=' + full_name + '&role_id=' + role_id + '&password=' + password);
       //res.json(user);
     }
 }
 );
 ...
 exports.putProfile = function (req, res) {
  ...
  console.log("start update user ");
       ...
       userInstance.save().then(function (user) {
         ...
         return res.redirect('/v1/user/profile');
